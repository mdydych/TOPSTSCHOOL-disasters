...
The integration of multiple data sources can provide valuable insights, but satellite data has limitations:
- Cloud cover can obstruct observations
- Temporal and spatial resolution may miss important changes
- Data latency may affect real-time decision making
- Local conditions may differ from satellite-based measurements
...
We classify smoke coverage into two categories:
...
When analyzing smoke plume extent:
1. Consider both intensity (AOD values) and spatial coverage
2. Remember that AOD measures total column aerosol - smoke may be at various heights
3. Cloud cover can create gaps in the data
4. The 500km analysis radius helps capture regional-scale impacts
:::
