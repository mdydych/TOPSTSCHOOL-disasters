...
image_url = "https://nsidc.org/sites/default/files/images/Data/extn-09-1979-2024-arctic.gif"
display(Image(url=image_url, width=450, height=600))

link_html = '<a href="https://nsidc.org/sites/default/files/images/Data/extn-09-1979-2024-arctic.gif" target=_blank">Arctic sea ice animations, 1979 to 2024</a>'
display(HTML(link_html))
```
...
image_url ="https://www.climate.gov/sites/default/files/2024-12/arctic-report-card-2024--sea-ice--2400px.jpg"
display(Image(url=image_url, width=450, height=600))
link_html = '<a href="https://www.climate.gov/news-features/understanding-climate/2024-arctic-report-card-documents-rapid-dramatic-change">Arctic Sea Ice Summer Extent</a>'
display(HTML(link_html))
```
